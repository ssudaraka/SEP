    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="<?php echo base_url('index.php/inbox'); ?>" class="display-tooltip" data-toggle="tooltip" title="Inbox"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span></a></li>
