...
<html lang="en">
    ...
    <body>
        <header>
            ...
            <span>Attendance Report For: 06-07-2015</span>
            <img src="<?php echo base_url('assets/img/dslogo.jpg'); ?>" />
        </header>
        <div class="container">
            <div class="datagrid">
                <table>
                    ...
                    <tbody>
                        <?php foreach ($present_list as $present) : ?>
                            <tr>
                                ...
                                <td><?php echo $present->signature_no; ?></td>
                                <td><?php echo $present->name_with_initials; ?></td>
                            </tr>
                        <?php endforeach; ?> 
                    </tbody>
