        ...
        <div id="collapseOne" class="panel-collapse collapse in">
            <div class="panel-body">
                <table class="table">
                    <tr>
                        <td>
                            <span class="glyphicon glyphicon-user text-primary"></span><a href="<?php echo base_url('index.php/admin'); ?>">Profile</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span class="glyphicon glyphicon-cog text-warning"></span><a href="<?php echo base_url('index.php/admin/account_settings'); ?>">Account Settings</a>
                        </td>
                    </tr>
                </table>
            </div>
