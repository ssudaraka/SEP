  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
      	...
      	<li><a href="#"><i class="glyphicon glyphicon-user"></i><span>Teachers</span> </a> </li>
      	<li><a href="#"><i class="glyphicon glyphicon-bed"></i><span>Leave</span> </a> </li>
        ...
        <li><a href="admin"><i class="glyphicon glyphicon-cog"></i><span>Admin</span> </a> </li>
